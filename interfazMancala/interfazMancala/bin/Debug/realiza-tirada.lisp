...
(cond
	((= (- (- (nth 6 tirada) (nth 6 (cadr jugada))) (- (nth 7 tirada) (nth 7 (cadr jugada)))) 1) (setq tirada (append tirada '(H))))
	(t (setq tirada (append tirada '(M))))
)

(if (= (- (- (nth 6 tirada) (nth 6 (cadr jugada))) (- (nth 7 tirada) (nth 7 (cadr jugada)))) 1) ())
